...
- Added explicit Next viewport metadata and `w-full` shell sizing so the wallet renders at device width on mobile/headless capture instead of overflowing the screenshot viewport.
